...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProfileMeState);
}
...
/// @nodoc
class $ProfileMeStateCopyWith<$Res>  {
$ProfileMeStateCopyWith(ProfileMeState _, $Res Function(ProfileMeState) __);
}


/// Adds pattern-matching-related methods to [ProfileMeState].
extension ProfileMeStatePatterns on ProfileMeState {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
class _Initial implements ProfileMeState {
  const _Initial();
...
class _Loading implements ProfileMeState {
  const _Loading();
...
class _Loaded implements ProfileMeState {
  const _Loaded(this.profile);
  

 final  ProfileModel profile;

/// Create a copy of ProfileMeState
...
@override
String toString() {
  return 'ProfileMeState.loaded(profile: $profile)';
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $ProfileMeStateCopyWith<$Res> {
...
class _Error implements ProfileMeState {
...
@override
String toString() {
  return 'ProfileMeState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $ProfileMeStateCopyWith<$Res> {
